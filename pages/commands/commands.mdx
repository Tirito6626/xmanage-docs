...
[38;5;38m[Info][0m Server is started succesfully
```
### restart
> Restarts server
>
...
[38;5;38m[Info][0m Server is restarted succesfully
```
### stop
> Stops server
>
...
[38;5;38m[Info][0m Server is stopped succesfully
```
### status 
...
<extiting nano>
[38;5;38m[Info][0m Server's config was succesfully updated
```
### monitor 
...
...
[38;5;38m[Info][0m Backup was created succesfully
[38;5;38m[Info][0m Backup saved in /etc/xmanage/backups/2ccf94816b
```
### delete-backup
...
[38;5;38m[Info][0m Backup was deleted succesfully
```
### restore-backup
> Restores server from the backup
>
> Arguments: [Server ID/name] [backup_name]
> 
> Example usage:
```ansi
root@xmanage:~# xmanage server restore-backup MyServer 2024-02-21T12:53+01:00.tar.gz
```
...
> Example usage:
```ansi
root@xmanage:~# xmanage api start 
[38;5;38m[Info][0m Started API succesfully
```
### stop
> Stops API
>
...
> Example usage:
```ansi
root@xmanage:~# xmanage api stop
[38;5;38m[Info][0m Stopped API succesfully
```
### restart
> Restarts API
>
...
> Example usage:
```ansi
root@xmanage:~# xmanage api restart 
[38;5;38m[Info][0m Restarted API succesfully
```
### status
> Shows status of API
>
...
> Example usage:
```ansi
root@xmanage:~# xmanage api status
    Showing status of [38;5;38mMyServer[0m
    --------------------------
[38;5;38mState[0m        [38;5;2mactive[0m
[38;5;38mRAM[0m          [3M/128M]
[38;5;38mCPU[0m          [0%/100%]

[38;5;38mCPU Usage[0m    [                  [38;5;241m0%[0m]
[38;5;38mRAM Usage[0m    [|||               [38;5;241m2%[0m]
...
```
### run
> Starts API process directly
>
> Arguments: None
>
> Example usage:
```ansi
root@xmanage:~# xmanage api run
[38;5;38m[Info][0m Starting API on port 8041
```
### key generate
> Generates API key
>
...
> Example usage:
```ansi
root@xmanage:~# xmanage api key generate
```
### key delete
> Deletes API key
>
...
> Example usage:
```ansi
root@xmanage:~# xmanage api key delete PKG7bLaoMVV-PE34N5SWO7KrTF0-WwsWXKWcfqH6wMbDftd8kE
```
